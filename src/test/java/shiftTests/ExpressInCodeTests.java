...
public class ExpressInCodeTests {
    ...
    public void ExpressInCode_tryCatch_Exception() {
        try {
            ExpressInCode expressInCode = new ExpressInCode();
            String inputted = expressInCode.putIntoCode("THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG", 20);
        } catch (Exception ex) {
    ...
    public void ExpressInCode_codesText_String() throws Exception {
        ExpressInCode expressInCode = new ExpressInCode();
        String inputted = expressInCode.putIntoCode("THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG", 23);
